...
import com.venkat.repository.CoinRepository;
...
//        coinRepository.save(coins);
    ...
    public Coin findById(String coinId) throws Exception{
        ...
        try {
            ...
            optionalCoin = coinRepository.findCoinByCustomId(coinId);
        }  catch (NumberFormatException e) {
        // Handle the case where the input is not a valid number
        System.out.println("Invalid input: " + coinId + " is not a valid number.");
        return null;
    }
